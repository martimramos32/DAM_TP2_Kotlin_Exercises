...
fun main() {
    ...
    println("\n--- Id registry cache ---")
    val idCache = Cache<Int, String>() // instância criada da classe Cache que recebe um id (inteiro) e guarda através de um nome (String)
    ...
    //USO DA FUNCAO CHALLENGE
    val palavrasValidas = wordCache.filterValues {it>0}
    println("\nPalavras com contagem > 0: $palavrasValidas")
}